...
public class AccountController {
	...
	@ApiOperation(value = " get the Account Information",response = Account.class,notes = "Gives Complete Account Information with Accno" )
	...
	@ApiOperation(value = " Updates Account Info",response = String.class,notes = "Updates Accounts Information" )
	...
	@ApiOperation(value = " Delete Account Info",response = String.class,notes = "Delete Accounts Information" )
