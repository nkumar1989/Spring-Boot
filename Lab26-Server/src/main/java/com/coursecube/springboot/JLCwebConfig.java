...
public class JLCwebConfig implements WebMvcConfigurer {
	...
	return new ApiInfo("CourseCube API", "Course API - part of CourseCube Application", "1.1","Free API to use any time", new springfox.documentation.service
			.Contact("Srinivas Dande",
